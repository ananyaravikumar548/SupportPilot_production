...
function HelpItem({ icon: Icon, title, description, href }) {
  return (
    <Link
      to={href}
      className="block rounded-[10px] border border-[#dfe5e1] bg-white p-5 transition hover:border-[#1f7a45] hover:bg-[#fafbfa]"
    >
...
export default function CustomerDashboard() {
  ...
  return (
    <div className="mx-auto max-w-[1400px] space-y-5 pb-8">
      ...
      >
        <MyTickets initialTickets={tickets} limit={5} />
      </Card>
      ...
      <div className="grid gap-5 xl:grid-cols-12">
        <Card
          ...
          subtitle="Use these shortcuts to manage your support requests."
        >
          <div className="grid gap-4 md:grid-cols-2">
            <HelpItem
              icon={FiPlusSquare}
              title="Create a ticket"
              description="Describe your issue and let the AI workflow categorize and route it."
            ...
            <HelpItem
              ...
              description="Review ticket status, assignments, updates, and resolutions."
              href="/customer/tickets"
            />

            <HelpItem
              icon={FiMail}
              title="View email updates"
              description="Check delivery history for ticket and resolution notifications."
              href="/customer/email-logs"
            />
        ...
        >
          <div className="border-b border-white/10 px-5 py-4">
            ...
            <p className="mt-2 text-[12.5px] leading-6 text-white/70">
              AI-powered analysis is active on every ticket you submit.
            </p>
          </div>
          ...
          <div className="p-5">
            ...
            <div className="mt-4 rounded-[10px] border border-white/10 bg-white/5 px-4 py-3 text-[12px] text-white/70">
              Submit a detailed ticket and our AI workflow will analyze it,
              recommend a resolution, and route it to the right support queue.
            </div>
          </div>
        </motion.div>
      </div>
